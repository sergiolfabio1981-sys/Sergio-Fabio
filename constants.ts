...
export const INITIAL_HOTELS: Hotel[] = [
  {
    id: 'htl-rede-andrade',
    title: 'Rede Andrade Cecomtur',
    location: 'Florianópolis, Centro',
    pricePerNight: 55, // USD dummy
    description: 'Hotel céntrico con piscina y recepción 24h. Ideal para quienes buscan una ubicación estratégica en el centro de la isla.',
    images: ['https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?q=80&w=2070&auto=format&fit=crop'],
    stars: 3,
    amenities: ['Piscina', 'Recepción 24h', 'Wifi', 'Desayuno'],
    isOffer: false,
    rating: 6.8,
    reviewsCount: 200,
    lat: -27.595,
  ...
  {
    id: 'htl-porto-da-ilha',
    title: 'Porto Da Ilha Hotel',
    location: 'Florianópolis, Centro',
    pricePerNight: 85, // USD dummy
    description: 'Excelente opción en el centro. Cuenta con restaurante, gimnasio y habitaciones modernas. Alta puntuación por ubicación y servicio.',
    images: ['https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2070&auto=format&fit=crop'],
    stars: 4,
    amenities: ['Restaurante', 'Gimnasio', 'Wifi', 'Desayuno'],
    isOffer: true,
    discount: 10,
    rating: 9.0,
    reviewsCount: 450,
  ...
  {
    id: 'htl-bossa-jurere',
    title: 'Bossa Jurerê Hotel',
    location: 'Jurerê, Florianópolis',
    pricePerNight: 120, // USD dummy
    description: 'Encantador hotel en Jurerê. Jardines, estacionamiento y cercanía a la playa. Ambiente relajado y sofisticado.',
    images: ['https://images.unsplash.com/photo-1582719508461-905c673771fd?q=80&w=2025&auto=format&fit=crop'],
    stars: 4,
    amenities: ['Jardín', 'Estacionamiento', 'Wifi', 'Cerca de playa'],
    isOffer: false,
    rating: 8.9,
    reviewsCount: 300,
    lat: -27.438,
  ...
  {
    id: 'htl-farol-da-ilha',
    title: 'Farol da Ilha Hotel',
    location: 'Florianópolis',
    pricePerNight: 70, // USD dummy
    description: 'Hotel funcional con estacionamiento cubierto. Opción práctica para viajeros de negocios o turismo.',
    images: ['https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?q=80&w=2070&auto=format&fit=crop'],
    stars: 3,
    amenities: ['Estacionamiento', 'Cargador Eléctrico', 'Wifi'],
    isOffer: false,
    rating: 7.5,
    reviewsCount: 120,
    lat: -27.592,
  ...
  {
    id: 'htl-belle-arti',
    title: 'Belle Arti Pousada',
    location: 'Florianópolis',
    pricePerNight: 65, // USD dummy
    description: 'Posada acogedora con excelente calificación. Desayuno incluido y atención personalizada.',
    images: ['https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?q=80&w=2070&auto=format&fit=crop'],
    stars: 3,
    amenities: ['Desayuno', 'Jardín', 'Wifi'],
    isOffer: true,
    rating: 9.4,
    reviewsCount: 80,
    lat: -27.690,
...
export const INITIAL_RENTALS: Apartment[] = [
  {
    id: 'apt-dona-floripa',
    title: 'Dona Floripa Suites e Apartamentos',
    location: 'Florianópolis (Cerca Proyecto TAMAR)',
    pricePerNight: 90, // USD dummy
    description: 'Suites y departamentos cómodos. Venta de entradas y estacionamiento disponible. Ideal para visitar el Proyecto TAMAR.',
    images: ['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?q=80&w=2070&auto=format&fit=crop'],
    bedrooms: 1,
    maxGuests: 4,
    amenities: ['Wifi', 'Estacionamiento', 'Venta Entradas'],
    isOffer: false,
    rating: 8.5,
    reviewsCount: 50,
    lat: -27.570,
  ...
  {
    id: 'apt-agua-marinha',
    title: 'Agua Marinha by Viva',
    location: 'Florianópolis',
    pricePerNight: 110, // USD dummy
    description: 'Edificio con apartamentos completos a pasos de la playa. Cuenta con piscina y gimnasio.',
    images: ['https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=2080&auto=format&fit=crop'],
    bedrooms: 2,
    maxGuests: 5,
    amenities: ['Piscina', 'Gimnasio', 'Estacionamiento Gratis', 'Cerca Playa'],
    isOffer: true,
    rating: 9.1,
    reviewsCount: 110,
    lat: -27.400,
  ...
  {
    id: 'apt-ufsc',
    title: 'Apartamento Frente a UFSC',
    location: 'Florianópolis, Trindade',
    pricePerNight: 45, // USD dummy
    description: 'Ubicación estratégica frente a la universidad y el hospital. Departamento funcional y cómodo.',
    images: ['https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?q=80&w=2070&auto=format&fit=crop'],
    bedrooms: 1,
    maxGuests: 2,
    amenities: ['Wifi', 'Ubicación Céntrica', 'Cocina'],
    isOffer: false,
    rating: 8.0,
    reviewsCount: 20,
    lat: -27.600,
  ...
  {
    id: 'apt-charme-ingleses',
    title: 'Charme a Passos do Mar - Ingleses',
    location: 'Ingleses, Florianópolis',
    pricePerNight: 130, // USD dummy
    description: 'Excelente departamento en Ingleses con piscina y a pasos del mar. Puntuación perfecta 10.0.',
    images: ['https://images.unsplash.com/photo-1484154218962-a1c002085d2f?q=80&w=2070&auto=format&fit=crop'],
    bedrooms: 2,
    maxGuests: 4,
    amenities: ['Piscina', 'Cerca Playa', 'Wifi'],
    isOffer: true,
    discount: 5,
    rating: 10.0,
    reviewsCount: 15,
  ...
  {
    id: 'apt-discover-comfort',
    title: 'Discover Comfort and Leisure',
    location: 'Ponta das Canas, Florianópolis',
    pricePerNight: 100, // USD dummy
    description: 'Condominio cerca de Ponta das Canas. Ideal para descanso y ocio.',
    images: ['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?q=80&w=2070&auto=format&fit=crop'],
    bedrooms: 2,
    maxGuests: 5,
  ...
  {
    id: 'apt-residencial-diva',
    title: 'Residencial Diva',
    location: 'Florianópolis',
    pricePerNight: 60, // USD dummy
    description: 'Departamentos prácticos que aceptan mascotas. Buena opción económica.',
    images: ['https://images.unsplash.com/photo-1502005229766-3c8ef95a5d78?q=80&w=2074&auto=format&fit=crop'],
    bedrooms: 1,
    maxGuests: 3,
    amenities: ['Pet Friendly', 'Cocina'],
    isOffer: false,
    rating: 8.2,
    reviewsCount: 35,
    lat: -27.450,
  ...
  {
    id: 'apt-xtay-soho',
    title: 'Xtay Soho Florianópolis',
    location: 'Florianópolis, Centro',
    pricePerNight: 95, // USD dummy
    description: 'Apartamentos modernos en el centro con excelente valoración. Diseño contemporáneo.',
    images: ['https://images.unsplash.com/photo-1554995207-c18c203602cb?q=80&w=2070&auto=format&fit=crop'],
    bedrooms: 1,
    maxGuests: 2,
    amenities: ['Diseño Moderno', 'Wifi', 'Ubicación'],
    isOffer: true,
    rating: 10.0,
    reviewsCount: 12,
    lat: -27.594,
  ...
  {
    id: 'apt-floripa-residence',
    title: 'Floripa Residence - 3 Quartos',
    location: 'Cerca Floripa Shopping, Florianópolis',
    pricePerNight: 140, // USD dummy
    description: 'Amplio apartamento de 3 dormitorios cerca del shopping. Ideal familias grandes.',
    images: ['https://images.unsplash.com/photo-1613490493576-7fde63acd811?q=80&w=2071&auto=format&fit=crop'],
    bedrooms: 3,
    maxGuests: 7,
    amenities: ['3 Dormitorios', 'Cerca Shopping', 'Cocina'],
    isOffer: false,
    rating: 8.9,
    reviewsCount: 22,
    lat: -27.550,
  ...
  {
    id: 'apt-garden-437',
    title: 'Garden 437 Suites e Estudios',
    location: 'Florianópolis',
    pricePerNight: 75, // USD dummy
    description: 'Suites y estudios con buena puntuación. Wifi gratis incluido.',
    images: ['https://images.unsplash.com/photo-1564013799919-ab600027ffc6?q=80&w=2070&auto=format&fit=crop'],
    bedrooms: 1,
    maxGuests: 2,
    amenities: ['Wifi Gratis', 'Jardín'],
    isOffer: false,
    rating: 8.7,
    reviewsCount: 45,
    lat: -27.650,
