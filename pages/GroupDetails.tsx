      ...
      <div className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-30">
          <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
              ...
              <div className="relative">
                  ...
                  {isSharingMenuOpen && (<><div className="fixed inset-0 z-40" onClick={() => setIsSharingMenuOpen(false)}></div><div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border z-50 p-2"><a href={whatsappUrl} target="_blank" className="block px-4 py-2 hover:bg-gray-100 rounded text-sm text-green-600 font-bold">WhatsApp</a><a href={emailUrl} target="_blank" className="block px-4 py-2 hover:bg-gray-100 rounded text-sm text-blue-600 font-bold">Email</a><button onClick={handleSharePdf} className="block w-full text-left px-4 py-2 hover:bg-gray-100 rounded text-sm text-red-600 font-bold">Descargar PDF</button></div></>)}
              </div>
          </div>
      </div>
