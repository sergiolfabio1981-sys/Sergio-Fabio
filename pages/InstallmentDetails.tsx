...
const InstallmentDetails: React.FC = () => {
  ...
  const generateContractPDF = () => {
    ...
    const doc = new jsPDF();
    doc.text(`Contrato Cuotas: ${bookingCode}`, 20, 20);
    doc.save(`Contrato-${bookingCode}.pdf`);
  };
                ...
                <div className="bg-white p-8 rounded-xl w-full max-w-md text-center">
                    {!isPaid ? (
                        ...
                        <>
                            ...
                            <button onClick={generateContractPDF} className="w-full bg-gray-800 text-white py-3 rounded font-bold mb-3">Descargar Contrato PDF</button>
