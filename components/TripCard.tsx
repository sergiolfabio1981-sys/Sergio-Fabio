...
const TripCard: React.FC<TripCardProps> = ({ trip: item }) => {
  ...
  const FALLBACK_IMAGE = "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=2073&auto=format&fit=crop";
  const itemImages = Array.isArray(item.images) && item.images.length > 0 ? item.images : [FALLBACK_IMAGE];
  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden bg-gray-100">
        <img 
            src={itemImages[currentImageIndex] || FALLBACK_IMAGE} 
            alt={item.title}
