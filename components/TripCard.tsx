...
const TripCard: React.FC<TripCardProps> = ({ trip: item }) => {
  ...
  // Manual Navigation Only (Auto-play removed)
  ...
  return (
    ...
    {isQuickViewOpen && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm" onClick={() => setIsQuickViewOpen(false)}>
                ...
                <div className="overflow-y-auto">
                    ...
                    <div className="p-6">
                        ...
                        <button 
                            ...
                            className="w-full mb-4 flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold py-2 rounded-lg hover:shadow-lg hover:scale-[1.02] transition-all disabled:opacity-50"
                        >
                            {isGeneratingPdf ? (
                                <>
